...
describe('Ceasar cipher', () => {
  ...
  it('can encode', () => {
    expect(simpleCipher.encode('aaaaaaaa')).toEqual('lehungio')
  })

  it('can decode', () => {
    expect(simpleCipher.decode('lehungio')).toEqual('aaaaaaaa')
  })

  it('can encode self', () => {
    expect(simpleCipher.encode('lehungio')).toEqual('wiooamqc')
  })

  it('can decode self', () => {
    expect(simpleCipher.decode('wiooamqc')).toEqual('lehungio')
  })
})
